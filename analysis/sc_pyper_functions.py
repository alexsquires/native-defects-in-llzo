...
defects = import_calculations_from_file('../metadata/defects.yaml') # DFT defect calculation information
elements = import_calculations_from_file('../metadata/elements.yaml')     # DFT element calculation information
interest = import_calculations_from_file('../metadata/interest.yaml')     # DFT LLZO calculation information
